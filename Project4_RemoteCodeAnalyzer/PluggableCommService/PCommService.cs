...
namespace PluggableRepository
{
    ...
    // HACKHACK
    public static class CommEnvironment
    {
        public static string defaultStoragePath = @"..\..\Storage\";
    }
    // HACKHACK
    ...
    public class Receiver : IPluggableComm
    {
        ...
        public bool openFileForWrite(string name)
        {
            ...
            string userName = pathComponents[0];
            string batchName = pathComponents[1];
            string fileName = pathComponents[2];

            Console.WriteLine("{0} {0} {0}", userName, batchName, fileName);

            Directory.CreateDirectory(CommEnvironment.defaultStoragePath + "/" + userName);
            Directory.CreateDirectory(CommEnvironment.defaultStoragePath + "/" + userName + "/" + batchName);
    ...
    public class Sender
    {
         ...
         */
        public bool postFile(string fileSpec, string owner, string batchName, bool toServer, string destFileName)
        {
            FileStream fs = null;
            long bytesRemaining;
            ...
            try
            {
                if (toServer)
                {
                    ...
                    //string fileRef = owner + "/" + batchName + "/" + Path.GetFileName(fileSpec);
                    string fileRef = owner + "/" + batchName + "/" + Path.GetFileName(destFileName);
                ...
                else
                {
                    ...
                    string fileRef = "../../Storage/" + owner + "/" + batchName + "/" + Path.GetFileName(fileSpec);
                    ...
                    fileSpec = owner + "/" + batchName + "/" + Path.GetFileName(fileSpec);
    ...
    public class Comm
    {
        ...
        public bool postFile(string filename, string owner, string batchName, bool toServer, string destFileName)
        {
            return sndr.postFile(filename, owner, batchName, toServer, destFileName);
        }
        /*----< disconnect sender >------------------------------------*/
    ...
    class TestPCommService
    {
        ...
        /*public static bool testComm()
        {
            ...
            foreach (string name in names)
            {
                ...
                bool transferSuccess = comm.postFile(name, "admin");
